...
params.post = 1.4; % Trial poststim in seconds
...
params.filter.lp_freq = 100; % Lowpass cutoff frequency
params.filter.notch = sort([50:50:150 60:60:120]); % Notch (bandstop) filter frequencies
...
params.trigger_codes = [1 2 3 4 5 6]; % Trigger values to timelock
params.trigger_labels = {'D', 'P', 'T', 'F', 'O', 'G'}; % Labels corresponding to the trigger values
